...
export default function splash({
  name, logo, active, total, channels, iframe
}) {
  let div = dom('.splash',
    dom('p',
      'Join ', dom('b', name),
    ...
    dom('form',
      ...
      dom('button.loading', 'Get me an Invite')
    ),
    dom('p', 'or'),
    dom('button.start onlclick=window.open("//itproswhocare.slack.com/messages/general"', 'Start Chatting'), !iframe && dom('footer',
      'powered by ',
